...
export default function CalculatorForm() {
  ...
  return (
    <div className="relative w-full max-w-md rounded-lg bg-gradient-to-br from-amber-400 via-rose-500 to-amber-800 dark:from-amber-500/60 dark:via-rose-600/60 dark:to-amber-900/60 p-[2px] shadow-lg shadow-amber-900/20">
      <LanguageSwitcher />
